...
% parpool('local',12);
seisfile = '1450985_GNL91-112_____mig160001';
...
clearvars w_combi;
% save(strcat(seisfile,'_NLmeans_9_19_0_01.mat'),'w_out','-v7.3');
[data,Trhead,SegyHead] = ReadSegy(strcat(seisfile,'.sgy'));
WriteSegyStructure(strcat(seisfile,'_NLmeans_9_19_0_015.sgy'),SegyHead,Trhead,w_out,'revision',0,'dsf',1);
clearvars w_out
% quit force
